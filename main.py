...
class Music(commands.Cog):
    ...
    async def play_(self, ctx, *, search: str):
        ...
        result = ytdl.extract_info(search, download=False)  # We just want to extract the info
        if 'entries' in result:
            ...
            for i, item in enumerate(video):
                source = await YTDLSource.create_source(ctx, "https://www.youtube.com/watch?v=" + item["id"], loop=self.bot.loop, download=True)
...
if __name__ == "__main__":
    ...
    setup(bot)
    bot.run("ODg4ODUyMjc3Nzk5MDU1NDEw.YUYuMQ.dgou5-RUMCkV2X8tpE6Ahv1zs4o")